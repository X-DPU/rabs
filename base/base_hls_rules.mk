...
$(TEMP_DIR)/$(UPPER_DIR)/$(APP_DIR)/%.xo: $(UPPER_DIR)/$(APP_DIR)/%.cpp
	...
	@[ -e ${LOCAL_CONFIG_FILE} ] && { \
		faketime '2021-01-01 00:00:00' $(VPP) --config ${LOCAL_CONFIG_FILE} $(VPP_FLAGS) --kernel_frequency $(FREQ)  -c -k $(KERNEL_NAME) --temp_dir $(TEMP_DIR)/$(COMPILE_APP_DIR)  -I '$(<D)' -o'$@' '$<' ;\
	} || { \
		faketime '2021-01-01 00:00:00' $(VPP) $(VPP_FLAGS)  --kernel_frequency $(FREQ) -c -k $(KERNEL_NAME) --temp_dir $(TEMP_DIR)/$(COMPILE_APP_DIR)  -I '$(<D)' -o'$@' '$<' ;\
	}
